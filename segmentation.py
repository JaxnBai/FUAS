...
class Segconfig:
    ...
    def get_dataloader_net(self):
        ...
        if args.pretrain:
            print(args.pretrain)
            weights = torch.load(args.pretrain, map_location='cuda')
    ...
    def customized_validation_sam(self):
        ...
        with tqdm(total=n_val, desc='Validation round', unit='batch', leave=False) as pbar:
            for pack in val_loader:
                ...
                if prompt == 'click' or prompt == 'nothing':    
                    pt_dict = pack['pt']
...
#python inference_3_prompts.py -prompt nothing -image_path  /root/autodl-tmp/agent/image_test -pred_mask /root/autodl-tmp/agent/mask -pretrain /root/autodl-tmp/Medical_SAM2/logs/BTCV_MedSAM2_2025_04_21_19_32_12/Model/8_tol_10000.0.pth

#python inference_3_prompts.py -prompt click -origin_mask /root/autodl-tmp/agent/test_mask  -image_path  /root/autodl-tmp/agent/image_test -pred_mask /root/autodl-tmp/agent/mask -pretrain /root/autodl-tmp/Medical_SAM2/logs/BTCV_MedSAM2_2025_04_17_17_55_52/Model/latest_epoch_16_tol_0.013650267384946346.pth
